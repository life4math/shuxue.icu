...
正式题库位于 `/questions.html`，在线备课工作台位于 `/prep.html`，公开讲义目录
位于 `/lectures.html`。当前阶段与后续开发顺序见 `DEVELOPMENT_PLAN.md`。
...
| GET/POST/PATCH | `/api/v1/admin/questions` | 管理正式题目、版本与发布状态 |
| GET | `/api/v1/admin/question-picker` | 备课筛选已发布题目 |
| GET | `/api/v1/public/questions` | 获取不含答案和解析的题目发布快照 |
