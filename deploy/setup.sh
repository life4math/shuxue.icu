...
ExecStart=/var/www/shuxue/venv311/bin/gunicorn -w 2 -b 127.0.0.1:8000 --timeout 120 --graceful-timeout 30 server:app
ExecReload=/var/www/shuxue/venv311/bin/python migrate.py
ExecReload=/var/www/shuxue/venv311/bin/python seed_knowledge.py --bootstrap-missing
